...
description: >-
  ...
  Utiliser dès que l'utilisateur mentionne diagramme, schéma, architecture, flux,
...
- Nouvelle fonctionnalité, refactor, revue d’architecture.
- Schéma BDD, flux auth, onboarding équipe.
- Décision technique à aligner avant le code.

Les diagrammes restent **vivants** : les mettre à jour quand le code change.
