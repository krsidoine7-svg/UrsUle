...
model: opus
color: green
manifest: manifests/communication-excellence-coach_manifest.md
skills_manifest: ../../../../.skills/ChefsUrsUle/references/skills_manifest.md
---

> **Manifeste compétences** : [`manifests/communication-excellence-coach_manifest.md`](manifests/communication-excellence-coach_manifest.md)  
> **Délégation inter-agents** : [`manifests/delegation_matrix.md`](manifests/delegation_matrix.md) — `[DEMANDE DÉLÉGATION → ChefsUrsUle]` obligatoire avant de confier une sous-tâche.
