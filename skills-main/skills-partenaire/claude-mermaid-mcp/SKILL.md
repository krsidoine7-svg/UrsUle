...
description: Creating and refining Mermaid diagrams with live reload via MCP. Use when mermaid_preview and mermaid_save tools are available and the user wants iterative diagram editing in the browser. Prefer skill-mermaidH (.skills/skill-mermaidH/) as the primary UrsUle skill unless MCP live preview is explicitly required.
